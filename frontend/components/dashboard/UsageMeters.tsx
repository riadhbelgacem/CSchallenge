  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-black/50 dark:text-white/50">{remaining} left</span>
      </div>
      <div className="relative">
        ...
        <span className="text-xs font-semibold text-black/70 dark:text-white/70 mt-1 block">{used} / {limit} used</span>
      </div>
    </div>
  );
};
...
export const UsageMeters: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-black/50 dark:text-white/50 mt-4 pt-4 border-t border-black/5 dark:border-white/10">
