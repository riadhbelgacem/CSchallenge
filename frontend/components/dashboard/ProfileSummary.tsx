      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 pb-4 border-b border-black/5 dark:border-white/10">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-black/50 dark:text-white/50 truncate">{data?.email}</div>
          </div>
        </div>
        ...
        <div className="space-y-2 text-sm">
          <div className="flex items-center justify-between">
            <span className="text-black/60 dark:text-white/60">Account Status</span>
            <span className={`flex items-center gap-1 font-medium ${data?.isActive ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400'}`}>
              {data?.isActive ? (
                <>
          ...
          <div className="flex items-center justify-between">
            <span className="text-black/60 dark:text-white/60">Email Verified</span>
            <span className={`flex items-center gap-1 font-medium ${data?.emailVerified ? 'text-green-600 dark:text-green-400' : 'text-orange-600 dark:text-orange-400'}`}>
              {data?.emailVerified ? (
                <>
